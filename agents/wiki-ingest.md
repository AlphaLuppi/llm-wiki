...
- **Langue : français exclusivement.** Tout le contenu du plan (titres, headings, prose, bullets, frontmatter, MOC, log, index) est rédigé en français. Si la source est en anglais ou autre, traduire / distiller en français dans le plan. Citer la source dans sa langue originale n'est autorisé qu'entre guillemets, et seulement pour appuyer une contradiction ou une définition technique précise.
